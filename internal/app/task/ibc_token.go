...
func (t *TokenTask) ibcTokenStatisticsType(baseDenom, denom string, tokenType entity.TokenType) entity.TokenStatisticsType {
	if baseDenom == denom {
		return entity.TokenStatisticsTypeGenesis
	}

	if tokenType == entity.TokenTypeAuthed {
